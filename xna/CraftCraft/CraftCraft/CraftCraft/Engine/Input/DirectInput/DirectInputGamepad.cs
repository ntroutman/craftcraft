...
using CraftCraft.Xna.Input;

namespace CraftCraft.Input.DirectInput
{
    public class DirectInputGamepad
    {
		...
		{
            Console.WriteLine("Reloading Gamepads");
			...
			foreach (DeviceInstance deviceInstance in gamepadInstanceList)
			{
                ...
                Console.WriteLine("Found Gamepad: " + deviceInstance.InstanceName + "(" + deviceInstance.InstanceGuid + ")");
				gamepads.Add(gamepad);
			}
			foreach (DeviceInstance deviceInstance in joystickInstanceList)
			{
				DirectInputGamepad gamepad = new DirectInputGamepad(deviceInstance.InstanceGuid);
                Console.WriteLine("Found joystick: " + deviceInstance.InstanceName + "(" + deviceInstance.InstanceGuid + ")");
				gamepads.Add(gamepad);
			}
		}
